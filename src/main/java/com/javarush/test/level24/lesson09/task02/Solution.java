    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                Double change1 = stock1.containsKey("change") ? (Double) stock1.get("change") :
                        (Double) stock1.get("last") - (Double) stock1.get("open");
                Double change2 = stock2.containsKey("change") ? (Double) stock2.get("change") :
                        (Double) stock2.get("last") - (Double) stock2.get("open");
                int compareChange = change2.compareTo(change1);
                if(compareChange != 0) return compareChange;
                return 0;
            }
        });
    }
