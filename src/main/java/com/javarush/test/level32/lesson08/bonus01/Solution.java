...
public class Solution {
    ...
    public <T extends Item> T getProxy(Class<T> class1, Class<?>... class2){
        Class[] arr = new Class[class2.length + 1];
        arr[0] = class1;
        System.arraycopy(class2, 0, arr, 1, class2.length);
        return (T) Proxy.newProxyInstance(class1.getClassLoader(), arr, new ItemInvocationHandler());
    }
}
